...
header-image: ../images/vietnam.jpg
...
# Chinese Fashion and the "Mao Suit"
...
{% include images/figure-wrap.html
  image-path="../images/Socialist_Party_USA.svg.png"
  image-position="middle"
  image-width="30%"
  caption="The official logo of the Socialist Party of America."
  text=workers_text
%}
...
{% include images/figure-wrap.html
  image-path="../images/mao-suit.jpg"
  image-position="middle"
  image-width="50%"
  caption="A photo showing a young Mao Zedong wearing his suit, circa 1939."
  text=suit_text
%}

## Mao's Little Red Book In Western Hands

{% include images/figure-wrap.html
  image-path="../images/red_book.avif"
  image-position="middle"
  image-width="70%"
  caption="A propoganda poster depicting members of the Red Guards and People's Liberation Army with the Little Red Book."
  text=book_text
%}

{% capture signature_text %}
...
{% include images/figure-wrap.html
  image-path="../images/tankman.jpg"
  image-position="right"
  image-width="30%"
  caption="The famous image, captured by newscrew of Newsweek just after noon on June 5th, 1989."
  text=tankman_text
%}
